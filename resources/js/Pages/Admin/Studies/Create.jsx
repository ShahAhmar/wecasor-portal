...
export default function Create() {
    ...
    return (
        <AdminLayout title="Initialize New Study">
            ...
            <div className="max-w-4xl mx-auto py-12">
                <form onSubmit={submit} className="space-y-12">
                    ...
                    <div className="bg-white p-12 rounded-[3.5rem] border border-slate-200 shadow-xl shadow-slate-200/20">
                        <h3 className="text-xl font-black text-slate-800 mb-10 tracking-tight">Core Project Details</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="md:col-span-2 space-y-2">
                                ...
                                <input 
                                    ...
                                    placeholder="e.g., Global Cardiovascular Outcomes Registry"
                                />
                            ...
                            <div className="md:col-span-2 space-y-2 pt-4">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Detailed overview of the research objectives and protocols..."
                                />
                            </div>
                        </div>
                    </div>
                     ...
                     <div className="bg-white p-12 rounded-[3.5rem] border border-slate-200 shadow-xl shadow-slate-200/20">
                        <h3 className="text-xl font-black text-slate-800 mb-10 tracking-tight">Metrics & Governance</h3>
