...
export default function Create() {
    ...
    return (
        <AdminLayout title="Site Onboarding">
            ...
            <div className="max-w-4xl mx-auto py-12">
                <form onSubmit={submit} className="space-y-12">
                    ...
                    <div className="bg-white p-12 rounded-[3.5rem] border border-slate-200 shadow-xl shadow-slate-200/20">
                        <h3 className="text-xl font-black text-slate-800 mb-10 tracking-tight">Facility Identification</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="md:col-span-2 space-y-2">
                                ...
                                <input 
                                    ...
                                    placeholder="e.g., St. Luke's Research Hospital"
                                />
                    ...
                    <div className="flex items-center justify-end gap-6 pt-4">
                        <Link href="/admin/institutions" className="text-xs font-black text-slate-400 uppercase tracking-widest hover:text-slate-600 transition-colors">Discard Draft</Link>
                        <button 
                            type="submit" 
                            disabled={processing}
